...
# Set parser hook for <ncl></ncl> Nice Category List extension.           
  static public function Setup($Parser) {
    $categorylist = new NiceCategoryList($Parser);
  }
}
...
/*------------------------------------------------------------------------------
  ...
  public function __construct($Parser) {
    $Parser->setHook('ncl', array(&$this, 'hookNcl'));
  }
...
# public function hookNcl($category, $argv, &$parser) {
  ...
  # replace variables in $category by calling the parser on it
    ...
    //$category = $parser->preprocess($category, $parser->mTitle, $parser->mOptions, false);
